...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView detect = findViewById(R.id.workout1);
        detect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), WorkOutPageDesc.class);
                startActivity(intent);
            }
        });

        CardView detect2 = findViewById(R.id.workout2);
        detect2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), WorkOutPageDesc2.class);
                startActivity(intent);
            }
        });
        CardView detect3 = findViewById(R.id.workout3);
        detect3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), WorkOutPageDesc3.class);
                startActivity(intent);
            }
        });
