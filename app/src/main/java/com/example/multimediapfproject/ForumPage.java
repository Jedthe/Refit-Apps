...
public class ForumPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movePage = findViewById(R.id.adore);
        movePage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), "ADD FORUM BUTTON", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ForumPage.this, addForumPage.class);
